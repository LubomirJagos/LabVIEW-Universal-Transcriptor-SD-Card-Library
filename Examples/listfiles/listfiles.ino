        ...
        switch(wireUID_309_){
            case true:
            {
                ...
                switch(wireUID_1221_){
                    ...
                    {
                        File wireUID_1110_;
                        String wireUID_853_ = wireUID_995_;
                        unsigned short wireUID_857_ = 0;
                        unsigned char wireUID_361_;
                        unsigned char wireUID_1453_ = wireUID_576_;
                        wireUID_361_ = wireUID_1453_ + 1;
                        wireUID_1110_ = SD.open(wireUID_853_);
                        LVSubVI_LabVIEW_Universal_Transcriptor_SD_Card_LibraryprintDirectory(wireUID_361_,wireUID_1110_);
                        wireUID_1110_.close();
                         /* C code */
                     /* output assgn. */
                    }
